...
public class WelcomePage extends Page {
	...
	*/
	private By signButtonBig = By.cssSelector("[class='usa-button usa-button-big'][href='new-user.html']");
	private By email = By.cssSelector("[href='mailto:info@agency.gov']");
	private By phonenumber = By.cssSelector("body > footer > div.usa-footer-secondary_section > div > div.usa-footer-contact-links.usa-width-one-half > address > div:nth-child(1) > p > a");
	...
	protected boolean isLoaded() {
		...
		return ActionByLocator.isDisplayed(driver, signButtonBig, TIMEOUT_SECONDS);
	}

	@Override
	protected void load() {
		driver.get(LoadProperties.getApplicationURL("web.urlwelcome"));
		/* 
		waitForAngular();
