...
describe('ODDS demo', function() {
    beforeEach(function(done) {
        driver = new selenium.Builder()
            .forBrowser('chrome')
            .build();
        driver.get('https://sp.salientcrgt.com/')
            .then(function () {
                done();       
            });
    ...
    it('should analyze the Main Page', function () {

        driver.sleep(3000);
        // Change the below function to work for JavaScript
        // driver.switchTo().alert().authenticateUsing(new UserAndPassword(username , password ));

     //driver.switchTo().alert().dismiss();
     
 //     var alertMessage1 = driver.switchTo().alert().getText();
 //
 // console.log('ALERT1 =' +alertMessage1);
 //
 //     driver.sleep(50000);
 //
 //     var alertMessage2 = driver.switchTo().alert().getText();
     
     // console.log('ALERT2 =' +alertMessage2);
     
        driver.switchTo().alert().sendKeys("dxqizo66");
     
     console.log('ALERT WINDOW');
     
     console.log('ALERT USERNAME');
     
     driver.switchTo().alert().sendKeys(Key.TAB);   
       
     driver.switchTo().alert().sendKeys("Spectrumravi$19");
